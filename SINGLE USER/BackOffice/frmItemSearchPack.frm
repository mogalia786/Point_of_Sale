...
Begin VB.Form frmItemSearchPack 
   BackColor       =   &H80000016&
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton1 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmItemSearchPack.frx":0000
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin VB.Image Image1 
      Height          =   1575
      Left            =   4800
      Picture         =   "frmItemSearchPack.frx":001C
      Stretch         =   -1  'True
      Top             =   1200
      Width           =   1935
   End
End
Attribute VB_Name = "frmItemSearchPack"
...
If Len(lvw1.SelectedItem) = 0 Then Exit Sub
    ...
    frmCreatePackNew.tSC = lvw1.SelectedItem
    frmCreatePackNew.tBC = lvw1.SelectedItem.SubItems(1)
    'frmStockAdd.tSN = lvw1.SelectedItem.SubItems(2)
    frmCreatePackNew.tDESC = lvw1.SelectedItem.SubItems(2)
    frmCreatePackNew.tSell = lvw1.SelectedItem.SubItems(4)
    frmCreatePackNew.cTaxCode.Text = lvw1.SelectedItem.SubItems(3)
