...
For i = 1 To lvw1.ListItems.Count
    ...
    r.Update
    r.Close
    If Dir("C:\LABELS", vbDirectory) = "" Then
    MkDir "C:\LABELS"
    End If

    If Dir("c:\LABELS\" & UCase(lvw1.ListItems(i).SubItems(1)), vbDirectory) = "" Then
    MkDir "c:\LABELS\" & UCase(lvw1.ListItems(i).SubItems(1))
    End If
    Open "c:\LABELS\" & UCase(lvw1.ListItems(i).SubItems(1)) & "\barcode.TXT" For Output As #2
    Print #2, lvw1.ListItems(i).SubItems(2)
    Close #2
    Open "c:\LABELS\" & UCase(lvw1.ListItems(i).SubItems(1)) & "\price.TXT" For Output As #2
    Print #2, lvw1.ListItems(i).SubItems(8)
    Close #2
    Open "c:\LABELS\" & UCase(lvw1.ListItems(i).SubItems(1)) & "\description.TXT" For Output As #2
    Print #2, lvw1.ListItems(i).SubItems(4)
    Close #2
    Open "c:\LABELS\" & UCase(lvw1.ListItems(i).SubItems(1)) & "\stockcode.TXT" For Output As #2
    ...
    Open "c:\LABELS\" & UCase(lvw1.ListItems(i).SubItems(1)) & "\costprice.TXT" For Output As #2
    Print #2, cc
    Close #2
...
If rs.EOF = False Then
    ...
    With r
    .Open "select * from stockpurchasehistory where stockcodemain='" & search & "'", c, adOpenDynamic, adLockOptimistic
    End With
    If r.EOF = False Then
