...
If Len(txtSqlSN) > 0 And Len(txtSQLUID) > 0 And Len(txtSQLUserPwd) > 0 Then
Me.MousePointer = 11
With cs
...
's.copyfile "c:" & "\TestServer.txt", App.Path & "\TestServer.txt"
...
If Err.Number = 76 Then
    MsgBox Err.Description, vbCritical, "Cannot connect to Server!"
