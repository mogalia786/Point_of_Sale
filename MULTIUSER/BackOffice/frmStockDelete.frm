...
Begin VB.Form frmStockDelete 
   ...
   Begin VB.Image Image1 
      Height          =   975
      Left            =   5160
      Picture         =   "frmStockDelete.frx":0038
      Stretch         =   -1  'True
      Top             =   960
      Width           =   1215
   End
End
Attribute VB_Name = "frmStockDelete"
...
If Len(lSC.Caption) > 0 Then
    delete = MsgBox("Are you sure you wish to delete this stock?", vbYesNo, "Delete")
    If delete = vbYes Then
        With r
        .Open "delete from stock where stockcodemain='" & lvw1.SelectedItem & "'", c, adOpenDynamic, adLockBatchOptimistic
        End With
        'r.Update
        'r.Close
        With r
        .Open "delete from stockpurchasehistory where stockcodemain='" & lvw1.SelectedItem & "'", c, adOpenDynamic, adLockBatchOptimistic
        End With
        'r.Close
        With r
        .Open "delete from stockadjustment where stockcode='" & lvw1.SelectedItem & "'", c, adOpenDynamic, adLockBatchOptimistic
        End With
        'r.Close
        With r
        .Open "delete from sales where itemcodemain='" & lvw1.SelectedItem & "'", c, adOpenDynamic, adLockBatchOptimistic
        End With
        'r.Close
        With r
        .Open "delete from packslist where pstockcode='" & lvw1.SelectedItem & "'", c, adOpenDynamic, adLockBatchOptimistic
        End With
        'r.Close
        MsgBox "Stock successfully deleted"
    End If
 End If
...
lsold = QTYSOLD
With r
.Open "select * from stockpurchasehistory where stockcodemain='" & lvw1.SelectedItem & "' order by pid desc", c, adOpenDynamic, adLockOptimistic
End With
If r.EOF = False Then
