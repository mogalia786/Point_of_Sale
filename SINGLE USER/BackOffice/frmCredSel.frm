...
If Dir("c:" & "\Creditors", vbDirectory) = "" Then
MkDir "c:" & "\Creditors"
End If

Open "c:" & "\Creditors\" & Day(Date) & "#" & MonthName(Month(Date)) & "#" & Year(Date) & xHour & xMin & xSec & ".doc" For Output As #2
...
End With
    ...
    wd.Documents.Open "c:" & "\Creditors\" & Day(Date) & "#" & MonthName(Month(Date)) & "#" & Year(Date) & xHour & xMin & xSec & ".doc"
    wd.Visible = True
...
Close #2
    ...
    If MAPISession1.SessionID <> 0 Then 'signed on
        ...
        .AttachmentPathName = "c:" & "\Creditors\" & Day(Date) & "#" & MonthName(Month(Date)) & "#" & Year(Date) & xHour & xMin & xSec & ".doc"
