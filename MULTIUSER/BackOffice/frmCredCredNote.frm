...
Begin VB.Form frmCredCredNote 
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton1 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmCredCredNote.frx":0000
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton2 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmCredCredNote.frx":001C
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   End
End
Attribute VB_Name = "frmCredCredNote"
...
End If
With r
.Open "select * from creditorscreditnote", c, adOpenDynamic, adLockOptimistic
End With
r.AddNew
r!notedate = Format(pDate.Value, "DD/MM/YYYY")
r!creditor = UCase(cCred.Text)
r!noteno = txtCHQ.Text
r!invno = cINV.Text
r!amount = Format(txtAMT.Text, "#####.00")
r.Update
r.Close
res = MsgBox("Credit Note updated successfully! Do you wish to enter another credit note?", vbYesNo + vbQuestion, "Make another payment?")
If res = vbYes Then
    cCred.ListIndex = -1
    cINV.ListIndex = -1
    lBAL = ""
