...
Begin VB.Form frmCreatePackExisting2 
   BackColor       =   &H80000016&
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton1 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmCreatePackExisting2.frx":0000
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H80000016&
      Caption         =   "Scan / Enter barcode of item to add to pack"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox cTaxCode 
         Height          =   315
         ItemData        =   "frmCreatePackExisting2.frx":001C
         Left            =   4200
         List            =   "frmCreatePackExisting2.frx":001E
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton2 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmCreatePackExisting2.frx":0020
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
   ...
   End
End
Attribute VB_Name = "frmCreatePackExisting2"
...
If KeyCode = vbKeyReturn Then
    ...
    With r
    .Open "select * from packs where pBARCODE='" & txtsn & "'", c, adOpenDynamic, adLockOptimistic
    End With
    If r.EOF = False Then
    ...
    With r
    .Open "select * from STOCK where STOCKCODE='" & txtsn & "'", c, adOpenDynamic, adLockOptimistic
    End With
    If r.EOF = False Then
        'For i = 1 To lvw1.ListItems.Count
         '   If lvw1.ListItems(i).SubItems(1) = txtsn Then
        ...
        Set li = lvw1.ListItems.Add(, , r!stockcodeMAIN)
        
        
        li.SubItems(1) = r!stockcode
