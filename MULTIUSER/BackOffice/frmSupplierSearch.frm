...
Begin VB.Form frmSupplierSearch 
   ...
   Begin LVbuttons.LaVolpeButton LaVolpeButton1 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "frmSupplierSearch.frx":0000
      ALIGN           =   1
      IMGLST          =   "(None)"
      IMGICON         =   "(None)"
      ICONAlign       =   0
...
frmStockAdd.tSUP = lvw1.SelectedItem
frmStockAdd.tADD1 = lvw1.SelectedItem.SubItems(1)
frmStockAdd.tADD2 = lvw1.SelectedItem.SubItems(2)
frmStockAdd.tADD3 = lvw1.SelectedItem.SubItems(3)
frmStockAdd.tADD4 = lvw1.SelectedItem.SubItems(4)
frmStockAdd.tTEL = lvw1.SelectedItem.SubItems(5)
frmStockAdd.tFAX = lvw1.SelectedItem.SubItems(6)
frmStockAdd.cTerms.Text = lvw1.SelectedItem.SubItems(7)
frmStockAdd.lBAL.Text = lvw1.SelectedItem.SubItems(8)
