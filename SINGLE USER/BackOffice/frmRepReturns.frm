...
Begin VB.Form frmRepReturns 
   ...
   End
End
Attribute VB_Name = "frmRepReturns"
...
pbody = pbody + "  <p><b><font face=Times New Roman, Times, serif><u>RETURNS "
...
tQTY = 0
    ...
    pbody = pbody + "        <div align=left><b><font color=#FFFFFF>Return Date</font></b></div>"
    pbody = pbody + "      </td>"
    
    pbody = pbody + "      <td width=10%> "
    pbody = pbody + "        <div align=left><b><b><font size=2><font "
    pbody = pbody + "color=#FFFFFF>Stock Code</font></font></b></b></div>"
    pbody = pbody + "      </td>"

    pbody = pbody + "      <td width=10%> "
    pbody = pbody + "        <div align=center><b><b><font size=2><font "
    pbody = pbody + "color=#FFFFFF>Barcode</font></font></b></b></div>"
    pbody = pbody + "      </td>"
    
    pbody = pbody + "      <td width=10%> "
    pbody = pbody + "        <div align=center><b><b><font size=2><font "
    pbody = pbody + "color=#FFFFFF>S/N</font></font></b></b></div>"
    pbody = pbody + "      </td>"
    
    pbody = pbody + "      <td width=10%> "
    pbody = pbody + "        <div align=center><b><b><font size=2><font "
    pbody = pbody + "color=#FFFFFF>Qty Returned</font></font></b></b></div>"
    pbody = pbody + "      </td>"
    
    pbody = pbody + "      <td width=10%> "
    pbody = pbody + "        <div align=center><b><b><font size=2><font "
    pbody = pbody + "color=#FFFFFF>Teller</font></font></b></b></div>"
    pbody = pbody + "      </td>"

    pbody = pbody + "      <td width=25%> "
    pbody = pbody + "        <div align=center><b><b><font size=2><font "
    pbody = pbody + "color=#FFFFFF>Reason</font></font></b></b></div>"
    pbody = pbody + "      </td>"
    
    pbody = pbody + "      <td width=15%> "
    pbody = pbody + "        <div align=center><b><b><font size=2><font "
    pbody = pbody + "color=#FFFFFF>Customer</font></font></b></b></div>"
    pbody = pbody + "      </td>"
    
    pbody = pbody + "      <td width=10%> "
    pbody = pbody + "        <div align=center><b><b><font size=2><font "
    pbody = pbody + "color=#FFFFFF>Tel</font></font></b></b></div>"
    pbody = pbody + "      </td>"
    ...
    If c1.Value = 1 Then
        With r
        .Open "select * from returns where department='" & r3!department & "' order by returndate", c, adOpenDynamic, adLockOptimistic
        End With
    Else
        With r
        .Open "select * from returns where returndate>='" & Year(dFROM.Value) & "-" & Month(dFROM.Value) & "-" & Day(dFROM.Value) & " 00:00:00.000' and returndate<='" & Year(dTO.Value) & "-" & Month(dTO.Value) & "-" & Day(dTO.Value) & " 00:00:00.000' and department='" & r3!department & "' order by returndate", c, adOpenDynamic, adLockOptimistic
        End With
    End If
    Do While r.EOF = False
            ...
            pbody = pbody + "size=2>" & r!returndate & "</font></font></font></font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=10%> "
            pbody = pbody + "        <div align=left><font face=Arial, Helvetica, sans-serif><font face=Arial, "
            pbody = pbody + "Helvetica, sans-serif><font face=Arial, Helvetica, sans-serif><font "
            pbody = pbody + "size=2>" & UCase(r!stockcode) & "</font></font></font></font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=10%>"
            pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
            pbody = pbody + "size=2>" & r!barcode & "</font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=10%>"
            pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
            pbody = pbody + "size=2>" & r!serialnumber & "</font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=10%>"
            pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
            pbody = pbody + "size=2>" & r!qtyreturned & "</font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=10%>"
            pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
            pbody = pbody + "size=2>" & r!Teller & "</font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=25%>"
            pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
            pbody = pbody + "size=2>" & r!reason & "</font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=15%>"
            pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
            pbody = pbody + "size=2>" & r!customername & "</font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=10%>"
            pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
            pbody = pbody + "size=2>" & r!contactnumber & "</font></div>"
            pbody = pbody + "      </td>"
            
            pbody = pbody + "      <td width=10%>"
            pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
            pbody = pbody + "size=2>" & Format(r!refundamt, "####.00") & "</font></div>"
            pbody = pbody + "      </td>"
            pbody = pbody + "    </tr>"
            tQTY = tQTY + CInt(r!qtyreturned)
            TAmt = Format(TAmt + CDbl(r!refundamt), "#####.00")
            r.MoveNext
    ...
    r.Close
        ...
        pbody = pbody + "      <td width=10%>"
        pbody = pbody + "        <div align=right><font face=Arial, Helvetica, sans-serif "
        pbody = pbody + "size=2><b>" & tQTY & "</b></font></div>"
        pbody = pbody + "      </td>"
